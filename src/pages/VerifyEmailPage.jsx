...
export default function VerifyEmailPage({ token }) {
  ...
  return <main className="memory-login">
    <section className="memory-login-story"><a className="memory-login-brand" href="/"><img className="memory-login-logo" src={logo} alt="Postcards of Us" /></a><div><p className="memory-eyebrow">Email verification</p><h1>Keep your account reachable.</h1></div></section>
