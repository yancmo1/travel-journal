...
export default function ResetPasswordPage({ token }) {
  ...
  return <main className="memory-login">
    <section className="memory-login-story"><a className="memory-login-brand" href="/"><img className="memory-login-logo" src={logo} alt="Postcards of Us" /></a><div><p className="memory-eyebrow">Account recovery</p><h1>Choose a new key to your memories.</h1></div></section>
